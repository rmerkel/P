...
private:
	...
	bool ifStatement(int level, const SymbolTableEntry& context);

	/// while-statement production...
	bool whileStatement(int level, const SymbolTableEntry& context);

	/// repeat-statement production...
	bool repeatStatement(int level, const SymbolTableEntry& context);

 	/// for-statement production...
 	bool forStatement(int level, const SymbolTableEntry& context);

	/// return-statement production...
	bool returnStatement(int level, const SymbolTableEntry& context);
	...
	void statement(int level, const SymbolTableEntry& constant);

	/// Statement-list production...
	void statementList(int level, const SymbolTableEntry& constant);
